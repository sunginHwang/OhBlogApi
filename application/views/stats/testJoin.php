...
<head>
    ...
    <style>
        ...
        *, *:before, *:after {
        ...
        /*회원가입*/
        .member_check_area{padding-top: 1em;  text-align: center;  color: #888;}
                ...
                <div class="member_component">
                    ...
                    <div class="member_input_contents">
                        <div class="member_info_area">
                            ...
                            <input class="input_pwd" type="password" placeholder="비밀번호"/>
                            <input class="input_pwd_confirm" type="password" placeholder="비밀번호확인"/>
                            <input class="input_name" type="text" placeholder="이름"/>
                            <input class="input_nickname" type="text" placeholder="닉네임"/>
                            <input class="input_age" type="text" placeholder="나이"/>
                            <input class="input_phoneNumber" type="text" placeholder="핸드폰번호"/>
                            <input class="input_email" type="text" placeholder="이메일"/>
                            <div class="member_check_area"><p>비밀번호를 확인해주세요</p></div>
                            <button class="member_submit_btn">회원가입</button>
                        </div>
                    </div>
                </div>
            </div>
